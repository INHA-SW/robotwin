...
class Sapien_TEST(gym.Env):
    ...
    def setup_scene(self, **kwargs):
        ...
        shader_dir = os.environ.get("ROBOTWIN_CAMERA_SHADER_DIR", "rt")
        spp = int(os.environ.get("ROBOTWIN_RAY_TRACING_SPP", "32"))
        path_depth = int(os.environ.get("ROBOTWIN_RAY_TRACING_PATH_DEPTH", "8"))
        denoiser = os.environ.get("ROBOTWIN_RAY_TRACING_DENOISER", "oidn")
